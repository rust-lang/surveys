...
- Сообщество было грубым, неприветливым или иным образом отталкивающим
...
- Я всё ещё *активн**о* пытаюсь изучать Rust
- В течение 2024 года
...
- Бета-версия
- Последняя ночная (nightly) версия
- Определённая ночная (nightly) версия
- Кастомная версия (fork)
- Я не знаю
- Другое

### Если используете ночную (nightly) версию, почему?

Type: select all that apply

- Я не использую ночную (nightly) версию
- Привычка
- Для какой-то определённой или ряда используемых возможностей языка
- Мне нравится иметь доступ ко всем последним новшествам
- Для помощи в нахождении ошибок в ночной/nightly-версии
...
- Я могу обновить *ночную (nightly)* версию компилятора, не опасаясь, что мой код не скомпилируется
...
- Обновление до новой *ночной (nightly)* версии компилятора не требует никаких изменений или требует очень небольших и простых изменений в моем коде
...
### Какие нереализованные (или nightly) функции вы хотели бы чтобы стабилизировались?

Type: matrix

Rows:

- [Специализация](https://github.com/rust-lang/rust/issues/31844)
- [Генераторы/корутины](https://github.com/rust-lang/rust/issues/43122)
- [Асинхронные замыкания](https://github.com/rust-lang/rust/issues/62290)
- [Async-генераторы/корутины](https://github.com/rust-lang/rust/pull/118420)
- [If/while let выражения](https://github.com/rust-lang/rust/issues/53667)
- [Try блоки](https://github.com/rust-lang/rust/issues/31436)
- [Тип Never](https://github.com/rust-lang/rust/issues/35121)
- [Trait-алиасы](https://github.com/rust-lang/rfcs/blob/master/text/1733-trait-alias.md)
...
- [Трейт std::alloc::Allocator и улучшенная обработка OOM (out of memory)](https://github.com/rust-lang/rust/issues/32838)
- [Стабильный ABI](https://github.com/rust-lang/rust/issues/111423)
- [Переносимый SIMD](https://github.com/rust-lang/portable-simd)
...
- Невозможность сделать достаточно много в const fn
...
### Какие функции, стабилизированные за последние 12 месяцев, вы используете чаще всего?
...
- Я еще не могу использовать эту функцию
- Мне не нужна эта функция
- Я не знал что эта функция уже стабилизировна
...
- Обсуждение (ишуи, пул реквесты, прочее) в репозитории *внутри* rust-lang организации на GitHub
- Обсуждение (ишуи, пул реквесты, прочее) в репозитории *вне* rust-lang организации на GitHub
