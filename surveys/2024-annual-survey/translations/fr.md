...
- Je préfère utiliser une autre langue
...
- Courant 2017 ou 2018
- Courant 2016 ou avant
...
- Exercices en ligne (Rustlings, Rust by Exemple, etc.)
- Vidéos
- 
- 
- 
...
- Rust Rover (IDE IntelliJ Rust dédié)
...
- Une version spécifique de la version stable de Rust égale ou supérieure à 1.67
- Une version spécifique de la version stable de Rust plus ancienne que 1.67
- Version bêta
- Version nightly
...
- Spécialisation
- Générateurs/coroutines
- Closures asynchrones
- 
-  Si/pendant que les chaînes if/while let
- Blocs try
- Type never
- Traits améliorés (alias de trait, limites implicites, valeurs par défaut de type associées)
- 
- 
- 
- 
...
- 
- 
- Trait d&#39;allocation, meilleure gestion du MOO
- IBC stable
- 
...
- Priorité moyenne
- Priorité basse
- Ne devrait pas être prioritaire

### Y a-t-il des fonctionnalités non mentionnées ci-dessus que vous aimeriez voir priorisées ?

Type: free form

### Selon vous, quelle devrait être la priorité du travail sur les aspects suivants de Rust ?
...
- Taille binaire
- Utilisation de la mémoire (c&#39;est-à-dire combien de RAM rustc utilise lors de la compilation)
- Utilisation de l&#39;espace disque (par exemple, la taille du dossier cible)
- Bogues dans le compilateur (c'est-à-dire, les ICE, ou erreurs internes du compilateur, les erreurs de compilation, etc.)
- Messages d&#39;erreur du compilateur
- Expérience EDI
- Expérience de débogage
- Documentation (rustdoc, docs.rs)
- Système de construction (cargo)
- Gestion des packages (crates.io)
- Nouvelles fonctionnalités du langage
- Langage Rust et documentation de la bibliothèque standard
- 
- 
- 
- 
...
### Comment téléchargez-vous des librairies pour créer des projets Rust ?

Type: select all that apply

- J&#39;utilise crates.io
- J&#39;utilise un registre personnalisé/local/entreprise
- J&#39;utilise un miroir de crates.io
- Je ne sais pas

### Approximativement, à quelle fréquence contribuez-vous au projet Rust ?
...
- Ouvrir un ticket sur n'importe quel dépôt de l'organisation GitHub de rust-lang.
- Contribuer aux modifications du code (y compris les tests) concernant tout autres projets de l'organisation GitHub de rust-lang.
- Contribuer à des modifications non liées au code (documentation, commentaires, etc.) à n'importe quel projet de l'organisation GitHub de rust-lang.
...
- Forums ou chats non officiels de la communauté Rust (par exemple, reddit.com/r/rust, Hacker News, le Discord communautaire du Rust, etc.)
...
- Participer aux discussions (tickets, pull requests, etc.) sur un dépôt au sein de l'organisation GitHub de rust-lang.
- Participer aux discussions (tickets, pull requests, etc.) sur un dépôt en dehors de l'organisation GitHub de rust-lang.
...
- Oui
- Non (il envisage d&#39;embaucher d&#39;autres développeurs)
- Non (il n&#39;est pas prévu d&#39;embaucher des développeurs)
- je ne sais pas

### Êtes-vous d'accord avec les déclarations suivantes sur l'emploi du Rust ?

Type: matrix

Rows:

- Il est facile pour les candidats qualifiés de trouver des emplois utilisant Rust pour la majeure partie de la programmation.
- 
...
### Vos réponses aux questions suivantes aideront nos évaluateurs à effectuer des analyses de cohorte et à mieux comprendre la communauté Rust. Veuillez répondre en fonction de votre niveau de confort. Vous considérez-vous comme membre d’un groupe sous-représenté ou marginalisé dans le domaine de la technologie ?
...
- Oui, dans un programme de baccalauréat/de premier cycle universitaire
