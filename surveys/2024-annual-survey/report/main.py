...
from surveyhero.render import render_blog_post, render_report_to_pdf, render_all_charts
...
def annual_survey_2024_report() -> ChartReport:
    ...
    answers_2023 = parse_surveyhero_answers(
        Path(ROOT_DIR / "data/data-full-2023.csv"), year=2023
    )
    answers_2024 = parse_surveyhero_answers(
        Path(ROOT_DIR / "data/data-full-2024.csv"), year=2024
    )
    ...
    report.add_bar_chart(
        "do-you-use-rust",
        r_2024.q(0).rename_answers(rename),
        r_2023.q(0).rename_answers(rename),
    )

    base = r_2023.q(1).rename_answers(
        {
            "I no longer have the opportunity to use Rust due to factors outside of my control": "I no longer have the opportunity to use Rust due to factors outside my control"
        }
    )
    report.add_bar_chart(
    ...
    report.add_wordcloud(
        "why-did-you-stop-using-rust-wordcloud",
        answers_2024.answers[10] + answers_2024.answers[11],
    )

    base = r_2023.q(2).rename_answers(
        {
            "I can't use Rust due to factors outside of my control": "I can't use Rust due to factors outside my control"
        }
    )
    report.add_bar_chart(
        "why-dont-you-use-rust",
        r_2024.q(2),
        base,
        bar_label_vertical=True,
        xaxis_tickangle=45,
    ...
    report.add_bar_chart(
        ...
        r_2022.q(4).rename_answers(
            {**expertise_diff, "I can't read or write Rust": "I can't write Rust code"}
        ),
        bar_label_vertical=True,
        xaxis_tickangle=45,
        max_tick_width=40,
    ...
    report.add_bar_chart(
        "what-kind-of-learning-materials-have-you-consumed",
        r_2024.q(6).rename_answers({"Other (please specify)": "Other"}),
        xaxis_tickangle=45,
        bar_label_vertical=True,
        max_tick_width=40,
    )
    report.add_wordcloud(
        "what-kind-of-learning-materials-have-you-consumed-wordcloud",
        answers_2024.answers[37],
    )

    report.add_bar_chart("have-you-taken-a-rust-course", r_2024.q(7), r_2023.q(22))

    windows_diff = {"Windows": ["Windows 10/11", "Windows 8 or older"]}
    report.add_bar_chart(
        "which-os-do-you-use",
        r_2024.q(8).combine_answers(windows_diff),
        r_2023.q(7).combine_answers(windows_diff),
        r_2022.q(6).rename_answers({"Mac OS": "macOS"}),
        bar_label_vertical=True,
        max_tick_width=20,
    )
    ...
    ide_diff = {"Rust Rover (dedicated IntelliJ Rust IDE)": "Rust Rover"}
    ...
    report.add_wordcloud(
        "which-version-of-rust-do-you-use-wordcloud", answers_2024.answers[81]
    )

    report.add_bar_chart(
        "if-you-use-nightly-why", r_2024.q(12), xaxis_tickangle=45, max_tick_width=40
    )
    ...
    report.add_wordcloud(
        "which-features-do-you-want-stabilized-wordcloud", answers_2024.answers[121]
    )
    ...
    report.add_matrix_chart(
        ...
        textposition="inside",
        max_label_width=40,
        legend_params=dict(y=-0.05, orientation="h"),
    )
    report.add_wordcloud(
        "which-problems-limit-your-productivity-wordcloud", answers_2024.answers[142]
    )
    ...
    report.add_wordcloud(
        "how-do-you-build-your-rust-projects-wordcloud", answers_2024.answers[162]
    )

    report.add_bar_chart(
        "how-do-download-crates", r_2024.q(20), r_2023.q(18), xaxis_tickangle=45
    )
    ...
    report.add_matrix_chart(
        ...
        textposition="inside",
        max_label_width=30,
        legend_params=dict(orientation="h"),
        height=800,
    )
    ...
    report.add_bar_chart(
        "do-you-personally-use-rust-at-work",
        r_2024.q(25),
        r_2023.q(26),
        r_2022.q(17),
        max_tick_width=24,
    ...
    report.add_bar_chart(
        "technology-domain",
        r_2024.q(29).rename_answers(technology_diff),
        base,
        legend_params=dict(orientation="h", y=1),
        xaxis_tickangle=90,
        bar_label_vertical=True,
        max_tick_width=50,
    )
    ...
    report.add_bar_chart(
        "is-your-organization-planning-on-hiring-rust-developers",
        r_2024.q(31),
        r_2023.q(32),
        legend_order=[
            "No",
    ...
    categories = ["Agree", "Neither agree nor disagree", "Disagree"]
    report.add_matrix_chart(
    ...
    report.add_bar_chart(
        "which-of-the-following-statements-about-rust-do-you-agree-with",
        r_2024.q(33),
        r_2023.q(33),
        xaxis_tickangle=45,
        bar_label_vertical=True,
    ...
    report.add_bar_chart(
        "what-are-your-biggest-worries-about-rust",
        question,
        base,
        xaxis_tickangle=55,
        max_tick_width=45,
    ...
    report.add_wordcloud(
        "what-are-your-biggest-worries-about-rust-wordcloud", answers_2024.answers[264]
    )

    question = r_2024.q(35)
    report.add_pie_chart(
        "do-you-consider-yourself-to-be-a-part-of-an-underrepresented-group", question
    )
    ...
    report.add_bar_chart(
        "in-what-ways-are-you-comfortable-communicating",
        r_2024.q(40),
        xaxis_tickangle=45,
        max_tick_width=45,
    )
    report.add_bar_chart(
        "what-are-your-preferred-languages-for-technical-communication",
        r_2024.q(41),
        xaxis_tickangle=45,
    )
    return report
...
if __name__ == "__main__":
    ...
    data_export_path = Path("surveys/2024-annual-survey/report/files")
    render_blog_post(
    ...
    render_all_charts(report, data_export_path)
