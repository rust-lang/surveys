...
<!-- chart: limiting-workflows (height=500) -->
...
<!-- chart: rebuild-wait-time (height=400) -->
...
<!-- chart: rebuild-wait-time-code-size (height=600) -->

And to a lesser factor also on the number of used dependencies:

<!-- chart: rebuild-wait-time-dep-count (height=800) -->
...
<!-- chart: cargo-commands (height=500) -->
...
<!-- chart: required-debuginfo (height=400) -->
...
<!-- chart: required-debuginfo-debugger (height=400) -->
...
<!-- chart: compile-time-improvement-mechanisms -->
...
<!-- chart: alternative-linker (height=500) -->
...
<!-- chart: profiling-tools (height=450) -->
