...
**Важливо**: Це запитання конкретно про операційні системи або середовища виконання, **для яких ведеться розробка**, а не операційні системи, які використовуються для розробки, і не конкретні архітектури (напр., x86 чи ARM), для яких ведеться розробка.
