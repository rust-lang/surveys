# Опитування про стан Rust, 2025 рік

## Річне опитування спільноти мови програмування Rust, 2025 рік

Не важливо, чи використовуєте ви [мову програмування Rust](https://rust-lang.org), чи ні. Сьогодні ми хочемо почути вас!

Rust Survey Team створила це опитування, щоб допомогти нам зрозуміти як виглядає Rust спільнота, оцінити як ми справляємося, що можна покращити, і яким чином найкраще взаємодіяти з усіма вами допоки ми продовжуємо розвиватись і рухатись вперед.
...
- Більше не маю змоги використовувати Rust із незалежних від мене причин
...
- Якщо ви поєднуєте Cargo з іншими системами збірки (або використовуєте тільки їх), назвіть які саме ви використовуєте (довільна відповідь)
...
- Компʼютерні мережі
- Компʼютерна безпека
- Аналіз та обробка даних (data science)
- Розробка баз даних
...
**Ваші відповіді на наступні запитання допоможуть нашим рецензентам провести когортний аналіз, щоб краще зрозуміти спільноту Rust. Будь ласка, відповідайте у межах вашого рівня комфорту.**
...
## Сторінка «Дякуємо за участь!»

Дякуємо за участь! Ми опублікуємо огляд результатів опитування у офіціному блозі Rust.
