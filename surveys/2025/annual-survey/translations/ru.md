...
Примечание: речь идет конкретно о том, какие системы вы лично используете для разработки, а не о системах под которые вы собираете проект.Вы можете выбрать несколько вариантов.
...
Примечание: речь идет именно о том, на какую операционную систему, среду выполнения и на какие конкретные архитектуры (например, x86 или ARM) вы собираете проект, а не о том, что вы используете для разработки.Вы можете выбрать несколько вариантов.
