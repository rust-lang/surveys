...
def annual_survey_2025_report() -> ChartReport:
    summary_2022 = parse_surveyhero_summary(Path(ROOT_DIR / "data/data-2022.csv"), year=20223)
    ...
    report.add_bar_chart("which-marginalized-group", summary.q_by_text(
