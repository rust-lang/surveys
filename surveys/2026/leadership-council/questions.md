...
summary after the survey is complete, similar to the one published in
[past years](https://blog.rust-lang.org/2024/08/26/council-survey/).
...
Council representative? This includes both knowing who to contact and your feeling that your perspective would be heard.
...
- We renewed apiraino's contract for compiler-ops for 2026.
- We selected a set of 3 new Rust Foundation Project Directory (Niko Matsakis, Jack Huey and David Wood). Project Directors and Lori Lorusso from the Foundation now frequently attend the Council meetings, which helps with increased communication between the Project the Foundation.
- We helped establish the Funding team and the RFC for maintainer funding and the cooperation with the Rust Foundation Maintainers Fund.
- We did some [work](https://blog.rust-lang.org/inside-rust/2025/12/10/leadership-council-update/#shape-of-rust) on categorizing and archiving working groups and teams to better fit within our team hierarchy.
...
### Do you have any other feedback or comments for the Leadership Council?
